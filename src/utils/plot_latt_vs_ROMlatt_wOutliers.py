...
threshold = 3 * std_residuals  # Outliers are points > 2 standard deviations from the fit
...
print(outliers[['Composition', 'Lattice Parameter (Å)', 'ROM_Lattice_Parameter',
